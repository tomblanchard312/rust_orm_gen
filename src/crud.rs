...
pub fn generate_crud_operations(table_name: &str, columns: HashMap<String, String>, author: &str, github_link: &str) -> String {
...
mod tests {
    ...
    fn test_generate_crud_operations() {
        ...
        let result = generate_crud_operations("users", columns, "Tom Blanchard", "https://github.com/tomblanchard312/rust_orm_gen");
